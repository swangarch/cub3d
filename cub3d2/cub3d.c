...
void draw_line_up_down(t_vars *vars, int i, double distance, int *color)
{
    ...
    // while (j < DISPLAY_W)
    // {
    //     draw_line(vars, POSITION_X + j * 5, POSITION_Y, POSITION_X + j * 5, POSITION_Y + DISPLAY_H / 2.0, CYAN);
    //     draw_line(vars, POSITION_X + j * 5,  POSITION_Y, POSITION_X + j * 5, POSITION_Y - DISPLAY_H / 2.0, MAGENTA);
    //     j++;
    // }
